...
--
-- Hôte : 127.0.0.1
-- Généré le :  jeu. 06 juil. 2017 à 20:40
...
--
-- Déchargement des données de la table `ref_codes`
--
...
(72, '', 'Olivier', 'ROULET', '', 'contact@olivierroulet.com', '0676818821', 2, 1, '2017-07-06 17:45:18', 1),
...
--
ALTER TABLE `clients`
  MODIFY `CL_Idclient` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
...
--
ALTER TABLE `devis`
  MODIFY `DV_Iddevis` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
