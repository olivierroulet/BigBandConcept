...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 12 Juillet 2017 à 10:10
...
--
-- Création :  Lun 10 Juillet 2017 à 12:49
--
...
CREATE TABLE `actu` (
  ...
  `AC_Com1` varchar(50) CHARACTER SET utf8 NOT NULL,
  `AC_Com2` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
  `AC_Num` varchar(8) CHARACTER SET utf8 DEFAULT NULL,
  `AC_Puce` varchar(150) CHARACTER SET utf8 DEFAULT NULL,
  `AC_Lieu` varchar(50) CHARACTER SET utf8 NOT NULL,
  `AC_Code_Postal` text CHARACTER SET utf8,
  `AC_Adresse` varchar(150) CHARACTER SET utf8 NOT NULL,
  `AC_Notes` varchar(150) CHARACTER SET utf8 DEFAULT NULL,
  `AC_Visibilite` varchar(10) CHARACTER SET utf8 DEFAULT 'Restreint'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- RELATIONS POUR LA TABLE `actu`:
--
...
(1, '2017-07-14 17:00:00', '2017-07-07 16:22:16', 'Actualite a ne pas rater', 'Actualite a ne pas rater A afficher urbi et orbi', '', 'unepuce une puce', 'Stade de France', '93000', 'pas loin', 'notes', 'Public'),
(2, '2017-07-13 17:00:00', '2017-07-07 16:22:16', 'Finie la formation !', 'commentaire 2 ', '123456', 'puce 2', 'Lieu 2', '13001', '', 'Notes', 'Public'),
(3, '2017-07-07 16:30:58', '0000-00-00 00:00:00', 'Fête massive', 'Tombez la chemise', '01234567', 'PUCE : Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maxime excepturi natus tempore obcaecati minus, aspernatur soluta cum voluptatum face', 'Bègles', '33130', 'Derrière la piscine', 'Sur le terrain de basket des intellos', 'Public'),
(4, '2017-07-07 16:32:53', '0000-00-00 00:00:00', 'Fête de l\' Huma', 'Comm2 Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maxime excepturi natus tempore obcaecati minus, aspernatur soluta cum voluptatum facere, odio deleniti placeat odit inventore a consectetur suscipit ipsam. Id, ea.', '01234567', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maxime excepturi natus tempore obcaecati minus, aspernatur soluta cum voluptatum facere, odi', 'Bébègles', '33130', 'Adresse donbi', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maxime excepturi natus tempore obcaecati minus, aspernatur soluta cum voluptatum facere, odi', 'Public'),
(5, '2017-11-09 17:00:00', '0000-00-00 00:00:00', 'Fête à Nono', 'Il y aura masse de foule, cravate exclue', '456789', 'pour la presse ce sera plus tard', 'Millau', '15000', 'Centre St Vincent de Paul', 'prévoir les parapluies quand même', 'Restreint');
...
--
-- RELATIONS POUR LA TABLE `agenda`:
--
...
--
-- Création :  Lun 10 Juillet 2017 à 14:31
--

CREATE TABLE `artistes` (
  `AR_Idartiste` int(11) UNSIGNED NOT NULL,
  `AR_ID_InUsersTable` int(10) NOT NULL COMMENT 'cet ID doit pointer sur users.US_id',
  `AR_Etiquette_Artiste` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  `AR_Etiquette_Artiste_Inversee` varchar(25) CHARACTER SET utf16 DEFAULT NULL,
  `AR_Emploi_Occupe` varchar(25) CHARACTER SET utf8 DEFAULT NULL,
  `AR_Civilite` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AR_Nom` varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AR_Prenom` varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AR_Pseudo` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  `AR_Password` varchar(150) CHARACTER SET utf8 NOT NULL,
  `AR_Numero` varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AR_Batiment` varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AR_Voie` varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AR_Adresse_Ligne_1` varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AR_Adresse_Ligne_2` varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AR_Code_Postal` varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AR_Ville` varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AR_Telephone_1` varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AR_Telephone_2` varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AR_Adresse_Mail` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  `AR_N_De_Securite_Sociale` varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AR_N_Du_Guso` varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AR_Numero_Conges_Spectacle` varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AR_Date_De_Naissance` date DEFAULT NULL,
  `AR_Anniversaire` varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AR_Lieu_De_Naissance` varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AR_Nationalite` varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AR_Etiquette_Dpae` varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AR_NewsLetterYN` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'si l'' artiste veut recevoir la newsletter',
  `AR_Etiquette_Feuille_De_Mandat` varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AR_Etiquette_Feuille_De_Presence` varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AR_Createur` varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AR_Date_De_Creation` datetime DEFAULT NULL,
  `AR_Modificateur` varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL,
  `AR_Date_De_Modification` datetime DEFAULT CURRENT_TIMESTAMP,
  `AR_ActiveYN` tinyint(1) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPACT;

--
-- RELATIONS POUR LA TABLE `artistes`:
--
...
(1, 4, NULL, NULL, 'niente', 'Mr', 'nowak', 'philippe', 'PhilTheNil', '$2y$10$qWFvVz.rlRPRKfzi/5eJTuENk7hEyNcptvh7P5OrxZKK8QbM3aVu6', '19', 'Senac', 'Rue', 'de Meilhan', NULL, '13001', 'Marseille', '0676818821', '0676818821', 'philippe@philnowak.net', '159046249804360', '0123456789', '0123456', '0000-00-00', NULL, 'Lens', 'FR', NULL, 0, NULL, NULL, NULL, NULL, NULL, '2017-07-04 12:18:29', 1),
(8, 4, NULL, NULL, 'Intermittent', 'Mr', 'De la Fontaine', 'Jean', 'Johnny Ah que', '$2y$10$HU3RU0XOHvSNW5f2Jm4A8OmAfd3jbLVCI4o407ci0iA4AcuigN8QW', '19', 'Senac', 'Rue', 'de Meilhan', NULL, '13008', 'Marseille', '0676818821', '0676818821', 'phil@phil.net', '159046249804360', '0123456789', '0123456', '1961-07-11', NULL, 'Cassis', 'FR', NULL, 0, NULL, NULL, NULL, NULL, NULL, '2017-07-04 13:46:38', 1),
(12, 4, NULL, NULL, 'niente', 'Mr', 'De la Fontaine', 'philippe', 'bbb', '$2y$10$Fw93unTpOxt4tgoI5Gy6Uu02qwxBmxB8l2nOb4FSvPz3.mmN7p/32', '19', 'Senac', 'Rue', NULL, NULL, '13001', 'Marseille', '0676818821', '', 'phil@phil.fr', '159046249804360', '0123456789', '0123456', '0000-00-00', NULL, 'Lens', 'FR', NULL, 0, NULL, NULL, NULL, NULL, NULL, '2017-07-04 15:02:04', 1),
(17, 81, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'dede@dede.fr', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, '2017-07-09 13:46:00', 1);
...
--
-- RELATIONS POUR LA TABLE `bloc_notes`:
--
...
--
-- RELATIONS POUR LA TABLE `bulletins_de_salaire`:
--
...
(13, 72, '', '', '', NULL, 'COMITE DES FETES DE LA PATATE FROIDE', 'association loi 1901', '', NULL, NULL, NULL, '', '0000-00-00 00:00:00', '', '2017-07-06 19:45:18', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(14, 73, '', '', '', NULL, 'COMITE DES FETES DE LA PATATE TIEDE', 'association loi 1901', '', NULL, NULL, NULL, '', '0000-00-00 00:00:00', '', '2017-07-06 19:46:13', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(15, 74, '', '', '', NULL, 'COMITE DES FETES DE LA PATATE GLACEE', 'association loi 1901', '', NULL, NULL, NULL, '', '0000-00-00 00:00:00', '', '2017-07-06 19:47:57', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(17, 76, '', '', '', NULL, 'Interpol', 'association loi 1901', '', NULL, NULL, NULL, '', '0000-00-00 00:00:00', '', '2017-07-12 09:18:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
-- RELATIONS POUR LA TABLE `contacts_utiles`:
--
...
--
-- RELATIONS POUR LA TABLE `contact_client`:
--
...
--
-- RELATIONS POUR LA TABLE `contrats`:
--
...
--
-- RELATIONS POUR LA TABLE `contrats_2`:
--
...
--
-- RELATIONS POUR LA TABLE `declarations_guso`:
--
...
--
-- RELATIONS POUR LA TABLE `declaration_pole_emploi`:
--
...
--
-- RELATIONS POUR LA TABLE `demande_devis`:
--
...
--
-- RELATIONS POUR LA TABLE `detail_devis`:
--

--
-- Contenu de la table `detail_devis`
--

INSERT INTO `detail_devis` (`DE_Iddetaildudevis`, `DE_Id_Devis`, `DE_Id_Operateur`, `DE_Id_Client`, `DE_Id_Contactclient`, `DE_Simulation_Aux_Anciennes_Conditions`, `DE_Statut_Du_Devis`, `DE_Bareme_Type`, `DE_Codepostalprestation`, `DE_Frais_Fixes`, `DE_Kms_De_Parthenay`, `DE_Kmsparthenayar`, `DE_Kms_De_Parthenay_2E_Vehicule_Ar`, `DE_Kms_Du_Mans`, `DE_Kmslemansar`, `DE_Option_Frais_Pat`, `DE_Kms_Pat_Ar`, `DE_Frais_De_Deplacement_Pat`, `DE_Frais_De_Deplacements_Odyssee`, `DE_Type_De_Vehicule`, `DE_Nb_De_Jours_De_Location`, `DE_Frais_De_Location_2E_Vehicule`, `DE_Frais_De_Deplacement_2E_Vehicule`, `DE_Frais_De_Deplacements_Danseuses`, `DE_Part_Dinvestissement`, `DE_Frais_De_Fonctionnement`, `DE_Frais_Supplementaires`, `DE_Deduction`, `DE_A_Reverser`, `DE_Operateur`, `DE_Adresseoperateurligne1`, `DE_Adresseoperateurligne2`, `DE_Codepostaloperateur`, `DE_Villeoperateur`, `DE_Formule`, `DE_Difference`, `DE_Cuivres`, `DE_Nb_De_Cuivres`, `DE_Danseuses`, `DE_Nb_De_Danseuses`, `DE_Chanteur_Supp`, `DE_Chanteuse_Supp`, `DE_Nb_Delements`, `DE_Option_Danseuses_Supp`, `DE_Option_Cuivre_Supp`, `DE_Proposition_Formule_Live`, `DE_Poste_Du_1Er`, `DE_Poste_Du_2E`, `DE_Poste_Du_3E`, `DE_Poste_Du_4E`, `DE_Poste_Du_5E`, `DE_Poste_Du_6E`, `DE_Poste_Du_7E`, `DE_7E_Declare_En`, `DE_Poste_Du_8E`, `DE_Poste_Du_9E`, `DE_Poste_Du_10E`, `DE_Poste_Du_11E`, `DE_Poste_Du_12E`, `DE_Poste_Du_13E`, `DE_Poste_Du_14E`, `DE_Poste_Du_15E`, `DE_Declaration_A_0_Pour_Le_1Er_Element`, `DE_Declaration_A_0_Pour_Le_2E_Element`, `DE_Declaration_A_0_Pour_Le_3E_Element`, `DE_Declaration_A_0_Pour_Le_4E_Element`, `DE_Declaration_A_0_Pour_Le_5E_Element`, `DE_Declaration_A_0_Pour_Le_6E_Element`, `DE_Declaration_A_0_Pour_Le_7E_Element`, `DE_Declaration_A_0_Pour_Le_8E_Element`, `DE_Declaration_A_0_Pour_Le_9E_Element`, `DE_Declaration_A_0_Pour_Le_10E_Element`, `DE_Declaration_A_0_Pour_Le_11E_Element`, `DE_Declaration_A_0_Pour_Le_12E_Element`, `DE_Declaration_A_0_Pour_Le_13E_Element`, `DE_Declaration_A_0_Pour_Le_14E_Element`, `DE_Declaration_A_0_Pour_Le_15E_Element`, `DE_Declaration_Du_1Er_A_0_Deja_Calculee`, `DE_Declaration_Du_2E_A_0_Deja_Calculee`, `DE_Declaration_Du_3E_A_0_Deja_Calculee`, `DE_Declaration_Du_4E_A_0_Deja_Calculee`, `DE_Declaration_Du_5E_A_0_Deja_Calculee`, `DE_Declaration_Du_6E_A_0_Deja_Calculee`, `DE_Declaration_Du_7E_A_0_Deja_Calculee`, `DE_Declaration_Du_8E_A_0_Deja_Calculee`, `DE_Declaration_Du_9E_A_0_Deja_Calculee`, `DE_Declaration_Du_10E_A_0_Deja_Calculee`, `DE_Declaration_Du_11E_A_0_Deja_Calculee`, `DE_Declaration_Du_12E_A_0_Deja_Calculee`, `DE_Declaration_Du_13E_A_0_Deja_Calculee`, `DE_Declaration_Du_14E_A_0_Deja_Calculee`, `DE_Declaration_Du_15E_A_0_Deja_Calculee`, `DE_Salaire_Net_Du_1Er`, `DE_Salaire_Net_Du_2E`, `DE_Salaire_Net_Du_3E`, `DE_Salaire_Net_Du_4E`, `DE_Frais_Professionnels_Du_4E`, `DE_Reste_Au_Final_Pat`, `DE_Salaire_Net_Du_5E`, `DE_Frais_Professionnels_Du_5E`, `DE_Reste_Au_Final_Fabrice`, `DE_Salaire_Net_Du_6E`, `DE_Frais_Professionnels_Du_6E`, `DE_Reste_Au_Final_Oliv`, `DE_Salaire_Net_Du_7E`, `DE_Salaire_Net_Du_8E`, `DE_Salaire_Net_Du_9E`, `DE_Salaire_Net_Du_10E`, `DE_Salaire_Net_Du_11E`, `DE_Salaire_Net_Du_12E`, `DE_Salaire_Net_Du_13E`, `DE_Salaire_Net_Du_14E`, `DE_Salaire_Net_Du_15E`, `DE_Salaire_Brut_Du_1Er`, `DE_Salaire_Brut_Du_2E`, `DE_Salaire_Brut_Du_3E`, `DE_Salaire_Brut_Du_4E`, `DE_Salaire_Brut_Du_5E`, `DE_Salaire_Brut_Du_6E`, `DE_Salaire_Brut_Du_7E`, `DE_Salaire_Brut_Du_8E`, `DE_Salaire_Brut_Du_9E`, `DE_Salaire_Brut_Du_10E`, `DE_Salaire_Brut_Du_11E`, `DE_Salaire_Brut_Du_12E`, `DE_Salaire_Brut_Du_13E`, `DE_Salaire_Brut_Du_14E`, `DE_Salaire_Brut_Du_15E`, `DE_Budget_Global_Du_1Er`, `DE_Budget_Global_Du_2E`, `DE_Budget_Global_Du_3E`, `DE_Budget_Global_Du_4E`, `DE_Budget_Global_Du_5E`, `DE_Budget_Global_Du_6E`, `DE_Budget_Global_Du_7E`, `DE_Budget_Global_Du_8E`, `DE_Budget_Global_Du_9E`, `DE_Budget_Global_Du_10E`, `DE_Budget_Global_Du_11E`, `DE_Budget_Global_Du_12E`, `DE_Budget_Global_Du_13E`, `DE_Budget_Global_Du_14E`, `DE_Budget_Global_Du_15E`, `DE_Salaire_Net_Cuivre_Supp`, `DE_Budget_Global_Cuivre_Supp`, `DE_Salaire_Net_Danseuse_Supp`, `DE_Budget_Global_Danseuse_Supp`, `DE_Kms_Du_Mans_Danseuse_Supp`, `DE_Kms_Du_Mans_Danseuse_Supp_Ar`, `DE_Frais_Danseuses_Supp`, `DE_Budget_Total_Danseuses_Supp`, `DE_Cotisation_Guso_Du_1Er`, `DE_Cotisation_Guso_Du_2E`, `DE_Cotisation_Guso_Du_3E`, `DE_Cotisation_Guso_Du_4E`, `DE_Cotisation_Guso_Du_5E`, `DE_Cotisation_Guso_Du_6E`, `DE_Cotisation_Guso_Du_7E`, `DE_Cotisation_Guso_Du_8E`, `DE_Cotisation_Guso_Du_9E`, `DE_Cotisation_Guso_Du_10E`, `DE_Cotisation_Guso_Du_11E`, `DE_Cotisation_Guso_Du_12E`, `DE_Cotisation_Guso_Du_13E`, `DE_Cotisation_Guso_Du_14E`, `DE_Cotisation_Guso_Du_15E`, `DE_Vignette_Urssaf_Du_1Er`, `DE_Vignette_Urssaf_Du_2E`, `DE_Vignette_Urssaf_Du_3E`, `DE_Vignette_Urssaf_Du_4E`, `DE_Vignette_Urssaf_Du_5E`, `DE_Vignette_Urssaf_Du_6E`, `DE_Vignette_Urssaf_Du_7E`, `DE_Vignette_Urssaf_Du_8E`, `DE_Vignette_Urssaf_Du_9E`, `DE_Vignette_Urssaf_Du_10E`, `DE_Vignette_Urssaf_Du_11E`, `DE_Vignette_Urssaf_Du_12E`, `DE_Vignette_Urssaf_Du_13E`, `DE_Vignette_Urssaf_Du_14E`, `DE_Vignette_Urssaf_Du_15E`, `DE_Etiquette_Lieu_Du_Devis`, `DE_Etiquetteadresoper`, `DE_Etiquadreopebasdepag`, `DE_Etiquetteadresseclient`, `DE_Etiquetteobjetdudevis`, `DE_Civilite_Du_Client`, `DE_Civilitetransformee`, `DE_Voicilacomposition`, `DE_Compositioncomplete`, `DE_Repertoiretousstyles`, `DE_Findedevis`, `DE_Indemnite_Conges_Spectacles`) VALUES
(4, 14, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(5, 15, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Musique de rue', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '4 Musiciens en acoustique\\n\r\n                2h00 d\'animation\\n\r\n                Salaires bruts : 4 x 181.19 €\\n\r\n                Cotisations salariale : 4 x 31.19 €\\n\r\n                Cotisations patronales : 4 x 102.19 €\\n\r\n                Salaires net : 4 x 150.00 €', NULL, NULL, NULL, NULL);
...
--
-- Création :  Mer 12 Juillet 2017 à 07:12
--
...
--
-- RELATIONS POUR LA TABLE `detail_devis_2`:
--

--
-- Contenu de la table `detail_devis_2`
--

INSERT INTO `detail_devis_2` (`D2_Iddetaildevis2`, `D2_Iddevis`, `D2_Option_Frais_Bruno`, `D2_Kms_De_Poitiers`, `D2_Deplacements_De_Bruno`, `D2_Option_Frais_Oliv`, `D2_Kms_Du_Tallud`, `D2_Deplacements_Doliv`, `D2_Frais_Supplementaires_Sans_Charges`, `D2_Titulaire_De_La_Licence_Dentrepreneur_De_Spectacles`, `D2_A_Rajouter_Au_Devis`, `D2_Devis_Final_Apres_Part_A_Rajouter`) VALUES
(2, 14, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, 15, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
-- Création :  Mar 11 Juillet 2017 à 11:24
--

CREATE TABLE `devis` (
  `DV_Iddevis` int(10) UNSIGNED NOT NULL,
  `DV_Createur` text COLLATE utf8_unicode_ci,
  `DV_Date_De_Creation` datetime DEFAULT CURRENT_TIMESTAMP,
  ...
  `DV_Datedudevis` datetime DEFAULT NULL,
...
(14, NULL, '2017-07-12 09:18:00', NULL, NULL, 17, NULL, NULL, NULL, NULL, '1970-01-01', NULL, NULL, NULL, '33130', 'Begles', NULL, NULL, NULL, NULL, NULL, 'a faire', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(15, NULL, '2017-07-12 09:18:03', NULL, NULL, 17, NULL, NULL, NULL, '2017-07-11 00:00:00', '1970-01-01', NULL, NULL, NULL, '33130', 'Begles', NULL, '600.00', '533.52', '171.90', '1305.42', 'a faire', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

--
-- Déclencheurs `devis`
--
DELIMITER $$
CREATE TRIGGER `INS_DevisDansSes2Fils` AFTER INSERT ON `devis` FOR EACH ROW BEGIN
...
--
-- RELATIONS POUR LA TABLE `dpae_imprime`:
--
...
--
-- RELATIONS POUR LA TABLE `feuilles_de_mandat`:
--
...
--
-- RELATIONS POUR LA TABLE `feuilles_de_presence`:
--
...
--
-- RELATIONS POUR LA TABLE `feuille_de_mandat`:
--

-- --------------------------------------------------------

--
-- Structure de la table `groupeinfo`
--
-- Création :  Lun 10 Juillet 2017 à 13:09
--

CREATE TABLE `groupeinfo` (
  `GI_ID` int(11) NOT NULL,
  `GI_Name` varchar(150) NOT NULL COMMENT 'Name of the Shop',
  `GI_PhotoMainPagePath` varchar(250) NOT NULL,
  `GI_Logo` varchar(250) NOT NULL,
  `GI_Address` varchar(250) NOT NULL,
  `GI_Addr_ZipCode` varchar(12) NOT NULL,
  `GI_Addr_City` varchar(100) NOT NULL,
  `GI_AddrPhone` varchar(20) NOT NULL,
  `GI_AddrMail` varchar(50) NOT NULL,
  `GI_Addr_Country` varchar(50) NOT NULL,
  `GI_OpeningHours` varchar(250) NOT NULL,
  `GI_Comments` varchar(250) NOT NULL,
  `GI_News` varchar(250) NOT NULL COMMENT 'To announce events, promotions, etc',
  `GI_RoleID` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- RELATIONS POUR LA TABLE `groupeinfo`:
--

--
-- Contenu de la table `groupeinfo`
--

INSERT INTO `groupeinfo` (`GI_ID`, `GI_Name`, `GI_PhotoMainPagePath`, `GI_Logo`, `GI_Address`, `GI_Addr_ZipCode`, `GI_Addr_City`, `GI_AddrPhone`, `GI_AddrMail`, `GI_Addr_Country`, `GI_OpeningHours`, `GI_Comments`, `GI_News`, `GI_RoleID`) VALUES
(1, 'Ze GroovyGroop', 'img/B_shop.jpg', 'img/B_logo.jpg', 'Rond-point de la Main Jaune', '86100', 'Châtellerault', '+33618480017', 'bigbandv4@gmail.com', 'FR', 'Lun-Ven : 10h00-13h00 et 14h00-19h30 Sam : 11h00-17h00 fermé le dimanche et jours fériés', 'Juillet et Août vont être très chargés pour le groupe.', 'Autographes et dédicaces (-10%) le lundi 24/07 de de 17h00 à 23h00', 1);
...
--
-- RELATIONS POUR LA TABLE `infos_administratives`:
--
...
--
-- RELATIONS POUR LA TABLE `lettre_accompagnement_du_contrat`:
--
...
--
-- RELATIONS POUR LA TABLE `location_u`:
--
...
--
-- RELATIONS POUR LA TABLE `messagerie`:
--
...
--
-- RELATIONS POUR LA TABLE `mise_a_jour`:
--
...
--
-- RELATIONS POUR LA TABLE `navigation_oliv`:
--
...
--
-- Création :  Mar 11 Juillet 2017 à 08:34
-- Dernière modification :  Mar 11 Juillet 2017 à 18:00
-- Dernière vérification :  Mer 12 Juillet 2017 à 06:57
--
...
CREATE TABLE `operateur` (
  ...
  `OP_Date_De_Creation` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
--
-- RELATIONS POUR LA TABLE `operateur`:
--
...
(1, 'M.', 'ROULET', 'Olivier', NULL, '7 Rue du Puits Descazeaux', 'Appt.6', '33000', 'BORDEAUX', NULL, '09.51.52.80.35', '06.76.81.88.21', 'contact@olivierroulet.com', '', '2017-07-11 10:35:00', '', '2017-07-11 09:27:24'),
(2, 'Mr', 'Nowak', 'Philippe', NULL, '19 Rue J Jaurès', NULL, '33130', 'Bègles', NULL, NULL, '0618480017', 'philippe@philnowak.net', '', '2017-07-11 10:37:00', '', '2017-07-11 10:34:05');
...
--
-- RELATIONS POUR LA TABLE `rappels`:
--
...
--
-- RELATIONS POUR LA TABLE `ref_codes`:
--
...
--
-- RELATIONS POUR LA TABLE `repertoire`:
--
...
--
-- RELATIONS POUR LA TABLE `salaires`:
--
...
--
-- RELATIONS POUR LA TABLE `simulations_guso`:
--
...
--
-- RELATIONS POUR LA TABLE `simulation_guso`:
--
...
--
-- Création :  Mar 11 Juillet 2017 à 17:35
--
...
--
-- RELATIONS POUR LA TABLE `suivi_client`:
--
...
--
-- RELATIONS POUR LA TABLE `table_utilisateur`:
--
...
--
-- RELATIONS POUR LA TABLE `userroles`:
--
...
--
-- Création :  Mer 12 Juillet 2017 à 07:47
--
...
CREATE TABLE `users` (
  ...
  `US_idURole` int(11) NOT NULL DEFAULT '4' COMMENT 'User role',
  ...
  `US_AuthorizedYN` tinyint(1) NOT NULL DEFAULT '0'
...
INSERT INTO `users` (`US_id`, `US_Password`, `US_FirstName`, `US_LastName`, `US_Pseudo`, `US_email`, `US_tel`, `US_idURole`, `US_ActiveYN`, `US_CreationDate`, `US_NewsLetter`, `US_AuthorizedYN`) VALUES
(2, '$2y$10$M7IjQjMkCAXDrzno8YN.mOZbFo3M6CZAgKUo6buzdTOVZdybTZhTS', 'p', 'PhilAdmin', '', 'philippe@philnowak.net', '+33618480017', 1, 1, '2017-07-11 17:39:11', 1, 1),
(59, '$2y$10$M7IjQjMkCAXDrzno8YN.mOZbFo3M6CZAgKUo6buzdTOVZdybTZhTS', '', '', 'administrateur', 'admin@bigband.fr', '', 1, 1, '2017-07-05 17:33:15', 1, 1),
(60, '$2y$10$RQ2cqUiUdcgXJpp1GZJER.zNBLz5U1kB44C4YH0EtCY7tQxskLB76', '', '', 'employeur', 'employeur@bigband.fr', '', 2, 1, '2017-07-05 17:32:30', 1, 1),
(61, '$2y$10$S1yhI3V9r0gCQ919nBhjSuN/WGCGA4yaCmyOPcJYFDnVLHewlz8Fe', '', '', 'artisteb', 'artiste@bigband.fr', '', 3, 1, '2017-07-05 17:33:56', 1, 1),
(62, '$2y$10$VpA1dnOUZISo23bZmOs2wu9T/zcwY02pzjkYN69Mc8TLZ2wgVAC9a', '', '', 'fanatique', 'fan@bigband.fr', '', 4, 1, '2017-07-05 17:46:01', 1, 1),
(63, '', 'OLIVIER', 'ROULET', '', 'webdev.oliv@gmail.com', '0676818821', 2, 1, '2017-07-06 08:59:13', 1, 1),
(72, '$2y$10$mSXc3ms1pjlYnNHpBr4arOnUw7TZNPBDh6D6NuqWySaYHfjk7zYE2', 'Olivier', 'ROULET', 'olivierroulet', 'contact@olivierroulet.com', '0676818821', 1, 1, '2017-07-07 12:32:50', 1, 1),
(74, '', 'André', 'ROULET', '', 'essai@olivierroulet.com', '0676818821', 2, 1, '2017-07-06 17:47:57', 1, 1),
(75, '$2y$10$BzLrct2afApQcegKM.zzVuWJ9lzyq1nU8/atYKIdqQgGebENO7MV2', 'Geoffrey', 'MOLLET', 'geoffreymollet', 'geoffrey.mollet@gmail.com', '0123456789', 1, 1, '2017-07-07 13:07:04', 1, 1),
(76, '', 'phil', 'now', '', 'philippenowak@gmail.com', '0618480017', 2, 1, '2017-07-12 07:18:00', 1, 0);

--
-- Déclencheurs `users`
--
DELIMITER $$
CREATE TRIGGER `INSArtisteAfterUserINS` AFTER INSERT ON `users` FOR EACH ROW BEGIN
...
--
-- RELATIONS POUR LA TABLE `utilisation_du_logiciel`:
--
...
--
-- RELATIONS POUR LA TABLE `verif_fiches_clients_a_suivre`:
--
...
--
-- RELATIONS POUR LA TABLE `versions_obsoletes`:
--
...
,`AR_Etiquette_Artiste` varchar(50)
,`AR_Etiquette_Artiste_Inversee` varchar(25)
,`AR_Emploi_Occupe` varchar(25)
,`AR_Civilite` varchar(15)
,`AR_Nom` varchar(25)
,`AR_Prenom` varchar(25)
,`AR_Pseudo` varchar(50)
,`AR_Password` varchar(150)
,`AR_Numero` varchar(25)
,`AR_Batiment` varchar(25)
,`AR_Voie` varchar(25)
,`AR_Adresse_Ligne_1` varchar(25)
,`AR_Adresse_Ligne_2` varchar(25)
,`AR_Code_Postal` varchar(25)
,`AR_Ville` varchar(25)
,`AR_Telephone_1` varchar(25)
,`AR_Telephone_2` varchar(25)
,`AR_Adresse_Mail` varchar(250)
,`AR_N_De_Securite_Sociale` varchar(25)
,`AR_N_Du_Guso` varchar(25)
,`AR_Numero_Conges_Spectacle` varchar(25)
,`AR_Date_De_Naissance` date
,`AR_Anniversaire` varchar(25)
,`AR_Lieu_De_Naissance` varchar(25)
,`AR_Nationalite` varchar(25)
,`AR_Etiquette_Dpae` varchar(25)
,`AR_NewsLetterYN` tinyint(1)
,`AR_Etiquette_Feuille_De_Mandat` varchar(25)
,`AR_Etiquette_Feuille_De_Presence` varchar(25)
,`AR_Createur` varchar(25)
,`AR_Date_De_Creation` datetime
,`AR_Modificateur` varchar(25)
...
--
DROP VIEW IF EXISTS `v_users_clients`;
...
ALTER TABLE `detail_devis`
  ADD PRIMARY KEY (`DE_Iddetaildudevis`),
...
ALTER TABLE `detail_devis_2`
  ADD PRIMARY KEY (`D2_Iddetaildevis2`),
...
--
-- Index pour la table `groupeinfo`
--
ALTER TABLE `groupeinfo`
  ADD PRIMARY KEY (`GI_ID`),
  ADD KEY `ID-RoleID` (`GI_RoleID`);
...
ALTER TABLE `suivi_client`
  ADD PRIMARY KEY (`SU_Idsuiviclient`);
...
--
ALTER TABLE `actu`
  MODIFY `AC_Id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `artistes`
  MODIFY `AR_Idartiste` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
...
--
ALTER TABLE `clients`
  MODIFY `CL_Idclient` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
...
--
ALTER TABLE `detail_devis`
  MODIFY `DE_Iddetaildudevis` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT pour la table `detail_devis_2`
--
ALTER TABLE `detail_devis_2`
  MODIFY `D2_Iddetaildevis2` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT pour la table `devis`
--
ALTER TABLE `devis`
  MODIFY `DV_Iddevis` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT pour la table `groupeinfo`
--
ALTER TABLE `groupeinfo`
  MODIFY `GI_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `operateur`
  MODIFY `OP_Idoperateur` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `suivi_client`
  MODIFY `SU_Idsuiviclient` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `users`
  MODIFY `US_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
...
--
-- Métadonnées pour la table groupeinfo
--
