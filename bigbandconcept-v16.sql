...
CREATE ALGORITHM=UNDEFINED DEFINER=root@localhost SQL SECURITY DEFINER VIEW bigband.v_activeuserroles  AS  select bigband.userroles.UR_ID AS UR_ID,bigband.userroles.UR_RoleDescr AS UR_RoleDescr,bigband.userroles.UR_ActiveYN AS UR_ActiveYN from bigband.userroles where (bigband.userroles.UR_ActiveYN = 1) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=root@localhost SQL SECURITY DEFINER VIEW bigband.v_agd_codes_active  AS  (select bigband.ref_codes.RF_Module AS RF_Module,bigband.ref_codes.RF_ModuleNumCodeValue AS RF_ModuleNumCodeValue,bigband.ref_codes.RF_ModuleCodeDescription AS RF_ModuleCodeDescription,bigband.ref_codes.RF_ActiveYN AS RF_ActiveYN,bigband.ref_codes.RF_InternalYN AS RF_InternalYN,bigband.ref_codes.RF_Internal2External AS RF_Internal2External,bigband.ref_codes.RF_External2Internal AS RF_External2Internal from bigband.ref_codes where ((bigband.ref_codes.RF_Module = 'AGD') and (bigband.ref_codes.RF_ActiveYN = 1))) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=root@localhost SQL SECURITY DEFINER VIEW bigband.v_agenda_pubpriv  AS  (select bigband.agenda.AG_Idagenda AS AG_Idagenda,bigband.agenda.AG_PubPriv AS AG_PubPriv,bigband.agenda.AG_Etiquette_De_La_Fiche AS AG_Etiquette_De_La_Fiche,bigband.agenda.AG_Id_Fiche_Concernee AS AG_Id_Fiche_Concernee,bigband.agenda.AG_Date_De_Rappel AS AG_Date_De_Rappel,bigband.agenda.AG_Note AS AG_Note,bigband.agenda.AG_Id_Rappel AS AG_Id_Rappel,bigband.agenda.AG_Eso_Esta_Hecho AS AG_Eso_Esta_Hecho,bigband.agenda.AG_RappelParUsrID AS AG_RappelParUsrID,bigband.agenda.AG_UPDINSParUsrID AS AG_UPDINSParUsrID,bigband.agenda.AG_UPDDate AS AG_UPDDate,v_agd_codes_active.RF_ModuleNumCodeValue AS PubPrivCode,v_agd_codes_active.RF_ModuleCodeDescription AS Pub_Priv,v_agd_codes_active.RF_ActiveYN AS RF_ActiveYN from (bigband.agenda join bigband.v_agd_codes_active on((bigband.agenda.AG_PubPriv = v_agd_codes_active.RF_ModuleNumCodeValue)))) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=root@localhost SQL SECURITY DEFINER VIEW bigband.v_users_and_roles  AS  select bigband.users.US_id AS US_id,bigband.users.US_Password AS US_Password,bigband.users.US_FirstName AS US_FirstName,bigband.users.US_LastName AS US_LastName,bigband.users.US_email AS US_email,bigband.users.US_tel AS US_tel,bigband.users.US_idURole AS US_idURole,bigband.users.US_ActiveYN AS US_ActiveYN,bigband.users.US_CreationDate AS US_CreationDate,bigband.users.US_NewsLetter AS US_NewsLetter,bigband.userroles.UR_RoleDescr AS UR_RoleDescr from (bigband.users join bigband.userroles on(((bigband.users.US_idURole = bigband.userroles.UR_ID) and (bigband.userroles.UR_ActiveYN = 1) and (bigband.users.US_ActiveYN = 1)))) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=root@localhost SQL SECURITY DEFINER VIEW bigband.v_users_clients  AS  (select bigband.artistes.AR_Idartiste AS AR_Idartiste,bigband.artistes.AR_ID_InUsersTable AS AR_ID_InUsersTable,bigband.artistes.AR_Etiquette_Artiste AS AR_Etiquette_Artiste,bigband.artistes.AR_Etiquette_Artiste_Inversee AS AR_Etiquette_Artiste_Inversee,bigband.artistes.AR_Emploi_Occupe AS AR_Emploi_Occupe,bigband.artistes.AR_Civilite AS AR_Civilite,bigband.artistes.AR_Nom AS AR_Nom,bigband.artistes.AR_Prenom AS AR_Prenom,bigband.artistes.AR_Pseudo AS AR_Pseudo,bigband.artistes.AR_Password AS AR_Password,bigband.artistes.AR_Numero AS AR_Numero,bigband.artistes.AR_Batiment AS AR_Batiment,bigband.artistes.AR_Voie AS AR_Voie,bigband.artistes.AR_Adresse_Ligne_1 AS AR_Adresse_Ligne_1,bigband.artistes.AR_Adresse_Ligne_2 AS AR_Adresse_Ligne_2,bigband.artistes.AR_Code_Postal AS AR_Code_Postal,bigband.artistes.AR_Ville AS AR_Ville,bigband.artistes.AR_Telephone_1 AS AR_Telephone_1,bigband.artistes.AR_Telephone_2 AS AR_Telephone_2,bigband.artistes.AR_Adresse_Mail AS AR_Adresse_Mail,bigband.artistes.AR_N_De_Securite_Sociale AS AR_N_De_Securite_Sociale,bigband.artistes.AR_N_Du_Guso AS AR_N_Du_Guso,bigband.artistes.AR_Numero_Conges_Spectacle AS AR_Numero_Conges_Spectacle,bigband.artistes.AR_Date_De_Naissance AS AR_Date_De_Naissance,bigband.artistes.AR_Anniversaire AS AR_Anniversaire,bigband.artistes.AR_Lieu_De_Naissance AS AR_Lieu_De_Naissance,bigband.artistes.AR_Nationalite AS AR_Nationalite,bigband.artistes.AR_Etiquette_Dpae AS AR_Etiquette_Dpae,bigband.artistes.AR_NewsLetterYN AS AR_NewsLetterYN,bigband.artistes.AR_Etiquette_Feuille_De_Mandat AS AR_Etiquette_Feuille_De_Mandat,bigband.artistes.AR_Etiquette_Feuille_De_Presence AS AR_Etiquette_Feuille_De_Presence,bigband.artistes.AR_Createur AS AR_Createur,bigband.artistes.AR_Date_De_Creation AS AR_Date_De_Creation,bigband.artistes.AR_Modificateur AS AR_Modificateur,bigband.artistes.AR_Date_De_Modification AS AR_Date_De_Modification,bigband.users.US_id AS US_id,bigband.users.US_Password AS US_Password,bigband.users.US_FirstName AS US_FirstName,bigband.users.US_LastName AS US_LastName,bigband.users.US_Pseudo AS US_Pseudo,bigband.users.US_email AS US_email,bigband.users.US_tel AS US_tel,bigband.users.US_idURole AS US_idURole,bigband.users.US_ActiveYN AS US_ActiveYN,bigband.users.US_CreationDate AS US_CreationDate,bigband.users.US_NewsLetter AS US_NewsLetter from (bigband.artistes join bigband.users) where (bigband.artistes.AR_ID_InUsersTable = bigband.users.US_id)) ;
