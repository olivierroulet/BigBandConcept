 ...
 */
class ClientsModel extends \W\Model\UsersModel // Attention à l' arborescence !!!
{

	public function __construct()
	{
		parent::__construct();
		$this->setPrimaryKey('CL_id'); // cette variable permet de ne pas être coincé par w\Model.php 
