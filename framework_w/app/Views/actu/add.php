	...
	if (isset($_SESSION['userrole'])) {
	  ...
	  <table id="ActuGrid" class="table table-condensed table-hover">
	  	<thead class="table-bordered headedW" style="font-family:Cuprum; font-weight:bold;">
	  		<tr><td> <!-- <button type="submit" id="ActuINS" name="ActuINS" value="ActuINS" class="btn btn-sm btn-default" title="Ajouter une nouvelle actualité"  style="width:100px;> < ?= '<a href="'.$this->url('ActuINS', ['AC_Id' => $reponse['AC_Id']]).'">Insérer</a>'; ?> <i class="glyphicon glyphicon-refresh"></i>
	  		</button> -->
	  	</td></tr>
	  ...
	  <!-- Fin de l' entête. On affiche les données ci-dessous -->
	  	...
	  	foreach($reponses as $reponse) {
	        ...
	        ?>
		        <tr class="normal">
		        	<td align="center"> 
		        		<button type="submit" id="ActuUpd" class="rond" title="Modifier ou désactiver l'évènement"> 
		        		<!-- < ?= '<a href="'.$this->url('actuUPD', ['AC_Id' => $reponse['AC_Id']]).'">ModifierSupprimer</a>'; ?> -->
