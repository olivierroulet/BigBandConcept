...
--
CREATE DATABASE IF NOT EXISTS `bigbandconcept` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `bigbandconcept`;
...
CREATE TABLE IF NOT EXISTS `agenda` (
  `AG_Idagenda` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`AG_Idagenda`),
  KEY `AG_Id_Fiche_Concernee` (`AG_Id_Fiche_Concernee`),
  KEY `AG_Id_Rappel` (`AG_Id_Rappel`)
...
CREATE TABLE IF NOT EXISTS `artistes` (
  `AR_Idartiste` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bloc_notes` (
  `BN_Id_Bloc_Notes` int(10) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`BN_Id_Bloc_Notes`),
  KEY `BN_Bloc_Notes_UserID` (`BN_Bloc_Notes_UserID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `bulletins_de_salaire` (
  `BS_Idbulletindepaie` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`BS_Idbulletindepaie`),
  KEY `BS_Idcontrat` (`BS_Idcontrat`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `clients` (
  ...
  PRIMARY KEY (`CL_Idclient`),
  KEY `CL_Date_De_Creation` (`CL_Date_De_Creation`),
  KEY `CL_Date_De_Creation_2` (`CL_Date_De_Creation`),
  KEY `CL_Date_De_Creation_3` (`CL_Date_De_Creation`),
  KEY `CL_Date_De_Modification` (`CL_Date_De_Modification`),
  KEY `CL_Date_De_Modification_2` (`CL_Date_De_Modification`),
  KEY `CL_Date_De_Creation_4` (`CL_Date_De_Creation`,`CL_Date_De_Modification`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `contacts_utiles` (
  `CU_Idcontactutiles` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`CU_Idcontactutiles`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `contact_client` (
  `CC_Idcontactclient` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`CC_Idcontactclient`),
  KEY `CC_Id_Client` (`CC_Id_Client`),
  KEY `CC_Id_Client_2` (`CC_Id_Client`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `contrats` (
  `CT_Id_Contrat` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `contrats_2` (
  ...
  PRIMARY KEY (`CD_Id_Contrat_2`),
  KEY `CD_Idcontrat2` (`CD_Idcontrat2`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `crdb` (
  `CR_Id_Crdb` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `declarations_guso` (
  `DG_Id_Declaration_Guso` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`DG_Id_Declaration_Guso`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `declaration_pole_emploi` (
  ...
  PRIMARY KEY (`DP_Id_Declaration_Pole_Emploi`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `demande_devis` (
  `DD_Iddemandededevis` int(10) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`DD_Iddemandededevis`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `detail_devis` (
  ...
  KEY `DE_Iddetaildudevis` (`DE_Iddetaildudevis`),
  KEY `DE_Id_Devis` (`DE_Id_Devis`),
  KEY `DE_Id_Operateur` (`DE_Id_Operateur`),
  KEY `DE_Id_Client` (`DE_Id_Client`),
  KEY `DE_Id_Contactclient` (`DE_Id_Contactclient`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `detail_devis_2` (
  ...
  KEY `D2_Iddetaildevis2` (`D2_Iddetaildevis2`),
  KEY `D2_Iddevis` (`D2_Iddevis`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `devis` (
  `DV_Iddevis` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `dpae_imprime` (
  ...
  KEY `DI_Id_Dpae` (`DI_Id_Dpae`),
  KEY `DI_Id_Contrat` (`DI_Id_Contrat`),
  KEY `DI_Numero_Du_Salarie` (`DI_Numero_Du_Salarie`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `feuilles_de_mandat` (
  ...
  KEY `FSM_Idfeuilledemandat` (`FSM_Idfeuilledemandat`),
  KEY `FSM_Id_Contrat` (`FSM_Id_Contrat`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `feuilles_de_presence` (
  ...
  KEY `FP_Idfeuilledepresence` (`FP_Idfeuilledepresence`),
  KEY `FP_Id_Contrat` (`FP_Id_Contrat`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `feuille_de_mandat` (
  ...
  KEY `FM_Id_Feuille_De_Mandat` (`FM_Id_Feuille_De_Mandat`),
  KEY `FM_Id_Contrat` (`FM_Id_Contrat`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `guso` (
...
CREATE TABLE IF NOT EXISTS `infos_administratives` (
  ...
  KEY `IA_Idinfosadministratives` (`IA_Idinfosadministratives`),
  KEY `IA_Id_Client` (`IA_Id_Client`),
  KEY `IA_Id_Contact_Client` (`IA_Id_Contact_Client`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `lettre_accompagnement_du_contrat` (
  ...
  KEY `LA_Idlettre` (`LA_Idlettre`),
  KEY `LA_Id_Contrat` (`LA_Id_Contrat`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `location_u` (
...
CREATE TABLE IF NOT EXISTS `navigation_oliv` (
...
CREATE TABLE IF NOT EXISTS `rappels` (
  `RA_Idrappel` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ref_codes` (
  `RF_CodeID` int(10) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`RF_CodeID`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='Codes num et alpha pour de petits ensembles de valeurs (moins de 100 plus ou moins statiques) définis par application';
...
CREATE TABLE IF NOT EXISTS `simulations_guso` (
...
CREATE TABLE IF NOT EXISTS `simulation_guso` (
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  KEY `US_idURole` (`US_idURole`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Users - their contacts and their roles';

--
-- Contenu de la table `users`
--

INSERT INTO `users` (`US_id`, `US_Password`, `US_FirstName`, `US_LastName`, `US_email`, `US_tel`, `US_idURole`, `US_ActiveYN`, `US_CreationDate`, `US_NewsLetter`) VALUES
(1, '$2y$10$tDiiUJySb6h22JIEoYs4beoTXJHGvuZ9ANpRczzzS8C9iQaOnwioC', 'Olivier', 'Roulet', 'contact@olivierroulet.com', '+33618480017', 2, 1, '2017-07-01 21:00:50', 1),
...
CREATE TABLE IF NOT EXISTS `utilisation_du_logiciel` (
...
CREATE TABLE IF NOT EXISTS `verif_fiches_clients_a_suivre` (
...
CREATE TABLE IF NOT EXISTS `versions_obsoletes` (
...
CREATE TABLE IF NOT EXISTS `v_activeuserroles` (
`UR_ID` int(11)
...
CREATE TABLE IF NOT EXISTS `v_agd_codes_active` (
`RF_Module` text
...
CREATE TABLE IF NOT EXISTS `v_agenda_pubpriv` (
...
CREATE TABLE IF NOT EXISTS `v_users_and_roles` (
`US_id` int(11)
