...
--
-- Client :  127.0.0.1
-- Généré le :  Dim 09 Juillet 2017 à 18:12
...
--
-- Base de données :  bigbandconcept
--
...
(12, 4, NULL, NULL, 'niente', 'Mr', 'De la Fontaine', 'philippe', 'bbb', '$2y$10$Fw93unTpOxt4tgoI5Gy6Uu02qwxBmxB8l2nOb4FSvPz3.mmN7p/32', '19', 'Senac', 'Rue', NULL, NULL, '13001', 'Marseille', '0676818821', '', 'phil@phil.fr', '159046249804360', '0123456789', '0123456', '0000-00-00', NULL, 'Lens', 'FR', NULL, 0, NULL, NULL, NULL, NULL, NULL, '2017-07-04 15:02:04'),
(13, 76, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, '2017-07-09 12:15:12'),
(16, 79, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'pepe@toto.fr', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, '2017-07-09 12:29:05'),
(17, 81, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'dede@dede.fr', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, '2017-07-09 13:46:00');
...
(79, '', '', '', '', 'pepe@toto.fr', '', 4, 1, '2017-07-09 10:29:05', 1, 1),
(80, '', '', '', 'me', 'me.toi@fr.fr', '', 4, 1, '2017-07-09 11:44:17', 1, 1),
(81, '', '', 'dede', '', 'dede@dede.fr', '', 3, 1, '2017-07-09 11:46:00', 1, 1);

--
-- Déclencheurs users
--
DROP TRIGGER IF EXISTS `INSArtisteAfterUserINS`;
DELIMITER $$
...
CREATE ALGORITHM=UNDEFINED DEFINER=root@localhost SQL SECURITY DEFINER VIEW bigbandconcept.v_activeuserroles  AS  select bigbandconcept.userroles.UR_ID AS UR_ID,bigbandconcept.userroles.UR_RoleDescr AS UR_RoleDescr,bigbandconcept.userroles.UR_ActiveYN AS UR_ActiveYN from bigbandconcept.userroles where (bigbandconcept.userroles.UR_ActiveYN = 1) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=root@localhost SQL SECURITY DEFINER VIEW bigbandconcept.v_agd_codes_active  AS  (select bigbandconcept.ref_codes.RF_Module AS RF_Module,bigbandconcept.ref_codes.RF_ModuleNumCodeValue AS RF_ModuleNumCodeValue,bigbandconcept.ref_codes.RF_ModuleCodeDescription AS RF_ModuleCodeDescription,bigbandconcept.ref_codes.RF_ActiveYN AS RF_ActiveYN,bigbandconcept.ref_codes.RF_InternalYN AS RF_InternalYN,bigbandconcept.ref_codes.RF_Internal2External AS RF_Internal2External,bigbandconcept.ref_codes.RF_External2Internal AS RF_External2Internal from bigbandconcept.ref_codes where ((bigbandconcept.ref_codes.RF_Module = 'AGD') and (bigbandconcept.ref_codes.RF_ActiveYN = 1))) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=root@localhost SQL SECURITY DEFINER VIEW bigbandconcept.v_agenda_pubpriv  AS  (select bigbandconcept.agenda.AG_Idagenda AS AG_Idagenda,bigbandconcept.agenda.AG_PubPriv AS AG_PubPriv,bigbandconcept.agenda.AG_Etiquette_De_La_Fiche AS AG_Etiquette_De_La_Fiche,bigbandconcept.agenda.AG_Id_Fiche_Concernee AS AG_Id_Fiche_Concernee,bigbandconcept.agenda.AG_Date_De_Rappel AS AG_Date_De_Rappel,bigbandconcept.agenda.AG_Note AS AG_Note,bigbandconcept.agenda.AG_Id_Rappel AS AG_Id_Rappel,bigbandconcept.agenda.AG_Eso_Esta_Hecho AS AG_Eso_Esta_Hecho,bigbandconcept.agenda.AG_RappelParUsrID AS AG_RappelParUsrID,bigbandconcept.agenda.AG_UPDINSParUsrID AS AG_UPDINSParUsrID,bigbandconcept.agenda.AG_UPDDate AS AG_UPDDate,v_agd_codes_active.RF_ModuleNumCodeValue AS PubPrivCode,v_agd_codes_active.RF_ModuleCodeDescription AS Pub_Priv,v_agd_codes_active.RF_ActiveYN AS RF_ActiveYN from (bigbandconcept.agenda join bigbandconcept.v_agd_codes_active on((bigbandconcept.agenda.AG_PubPriv = v_agd_codes_active.RF_ModuleNumCodeValue)))) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=root@localhost SQL SECURITY DEFINER VIEW bigbandconcept.v_users_and_roles  AS  select bigbandconcept.users.US_id AS US_id,bigbandconcept.users.US_Password AS US_Password,bigbandconcept.users.US_FirstName AS US_FirstName,bigbandconcept.users.US_LastName AS US_LastName,bigbandconcept.users.US_email AS US_email,bigbandconcept.users.US_tel AS US_tel,bigbandconcept.users.US_idURole AS US_idURole,bigbandconcept.users.US_ActiveYN AS US_ActiveYN,bigbandconcept.users.US_CreationDate AS US_CreationDate,bigbandconcept.users.US_NewsLetter AS US_NewsLetter,bigbandconcept.userroles.UR_RoleDescr AS UR_RoleDescr from (bigbandconcept.users join bigbandconcept.userroles on(((bigbandconcept.users.US_idURole = bigbandconcept.userroles.UR_ID) and (bigbandconcept.userroles.UR_ActiveYN = 1) and (bigbandconcept.users.US_ActiveYN = 1)))) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=root@localhost SQL SECURITY DEFINER VIEW bigbandconcept.v_users_clients  AS  (select bigbandconcept.artistes.AR_Idartiste AS AR_Idartiste,bigbandconcept.artistes.AR_ID_InUsersTable AS AR_ID_InUsersTable,bigbandconcept.artistes.AR_Etiquette_Artiste AS AR_Etiquette_Artiste,bigbandconcept.artistes.AR_Etiquette_Artiste_Inversee AS AR_Etiquette_Artiste_Inversee,bigbandconcept.artistes.AR_Emploi_Occupe AS AR_Emploi_Occupe,bigbandconcept.artistes.AR_Civilite AS AR_Civilite,bigbandconcept.artistes.AR_Nom AS AR_Nom,bigbandconcept.artistes.AR_Prenom AS AR_Prenom,bigbandconcept.artistes.AR_Pseudo AS AR_Pseudo,bigbandconcept.artistes.AR_Password AS AR_Password,bigbandconcept.artistes.AR_Numero AS AR_Numero,bigbandconcept.artistes.AR_Batiment AS AR_Batiment,bigbandconcept.artistes.AR_Voie AS AR_Voie,bigbandconcept.artistes.AR_Adresse_Ligne_1 AS AR_Adresse_Ligne_1,bigbandconcept.artistes.AR_Adresse_Ligne_2 AS AR_Adresse_Ligne_2,bigbandconcept.artistes.AR_Code_Postal AS AR_Code_Postal,bigbandconcept.artistes.AR_Ville AS AR_Ville,bigbandconcept.artistes.AR_Telephone_1 AS AR_Telephone_1,bigbandconcept.artistes.AR_Telephone_2 AS AR_Telephone_2,bigbandconcept.artistes.AR_Adresse_Mail AS AR_Adresse_Mail,bigbandconcept.artistes.AR_N_De_Securite_Sociale AS AR_N_De_Securite_Sociale,bigbandconcept.artistes.AR_N_Du_Guso AS AR_N_Du_Guso,bigbandconcept.artistes.AR_Numero_Conges_Spectacle AS AR_Numero_Conges_Spectacle,bigbandconcept.artistes.AR_Date_De_Naissance AS AR_Date_De_Naissance,bigbandconcept.artistes.AR_Anniversaire AS AR_Anniversaire,bigbandconcept.artistes.AR_Lieu_De_Naissance AS AR_Lieu_De_Naissance,bigbandconcept.artistes.AR_Nationalite AS AR_Nationalite,bigbandconcept.artistes.AR_Etiquette_Dpae AS AR_Etiquette_Dpae,bigbandconcept.artistes.AR_NewsLetterYN AS AR_NewsLetterYN,bigbandconcept.artistes.AR_Etiquette_Feuille_De_Mandat AS AR_Etiquette_Feuille_De_Mandat,bigbandconcept.artistes.AR_Etiquette_Feuille_De_Presence AS AR_Etiquette_Feuille_De_Presence,bigbandconcept.artistes.AR_Createur AS AR_Createur,bigbandconcept.artistes.AR_Date_De_Creation AS AR_Date_De_Creation,bigbandconcept.artistes.AR_Modificateur AS AR_Modificateur,bigbandconcept.artistes.AR_Date_De_Modification AS AR_Date_De_Modification,bigbandconcept.users.US_id AS US_id,bigbandconcept.users.US_Password AS US_Password,bigbandconcept.users.US_FirstName AS US_FirstName,bigbandconcept.users.US_LastName AS US_LastName,bigbandconcept.users.US_Pseudo AS US_Pseudo,bigbandconcept.users.US_email AS US_email,bigbandconcept.users.US_tel AS US_tel,bigbandconcept.users.US_idURole AS US_idURole,bigbandconcept.users.US_ActiveYN AS US_ActiveYN,bigbandconcept.users.US_CreationDate AS US_CreationDate,bigbandconcept.users.US_NewsLetter AS US_NewsLetter from (bigbandconcept.artistes join bigbandconcept.users) where (bigbandconcept.artistes.AR_ID_InUsersTable = bigbandconcept.users.US_id)) ;
